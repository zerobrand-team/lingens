    ...
    >
      ...
      <main className="flex-1 flex flex-col items-center text-center px-4 mt-12 md:mt-14 z-10 max-w-4xl mx-auto">
        ...
        <div className="animate-step delay-2 flex flex-col items-center">
            <button 
                onClick={onStart}
                className="bg-black text-white px-6 py-3 md:px-8 md:py-3 rounded-2xl md:rounded-[14px] tracking-[-0.04em] font-bold text-[18px] hover:bg-gray-800 active:scale-95 transition-all"
            >
                Try for Free
            </button>
