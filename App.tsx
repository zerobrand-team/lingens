          ...
          <div className="sticky top-0 z-50 bg-[#E8EBF0] pt-2">
            <div className="flex w-full border-b border-gray-300/50">
              <button
                ...
                className={`flex-1 pb-3 pt-4 text-sm font-bold uppercase tracking-wider transition-colors border-b-[3px] ${mobileTab === 'text'
              ...
              <button
                ...
                className={`flex-1 pb-3 pt-4 text-sm font-bold uppercase tracking-wider transition-colors border-b-[3px] ${mobileTab === 'image'
                    ? 'text-black border-black'
                    : 'text-gray-400 border-transparent hover:text-gray-600'
                  }`}
              >
                ...
                {(isDraftOpen || !generatedPost) && (
                  <div className="animate-in slide-in-from-top-2 fade-in duration-200 mt-4">
                    <div className="bg-[#F5F7F9] rounded-[24px] p-4 mb-4 border border-transparent focus-within:bg-white focus-within:border-gray-200 transition-all">
                      ...
                      />
                      {/* START WITH SAMPLE BUTTON (MOBILE) */}
                    ...
                    <div className="animate-in slide-in-from-top-2 fade-in duration-200">
                      <div className="bg-[#F5F7F9] rounded-[24px] p-6 mb-4 border border-transparent focus-within:bg-white focus-within:border-gray-200 transition-all">
                        <textarea
                          ...
                          onChange={(e) => setRawInput(e.target.value)}
                        />
                        {/* START WITH SAMPLE BUTTON (DESKTOP) */}
                        <div className="flex justify-end mt-1">
                          <span
                            onClick={() => {
                              const sampleText = "I’m building a startup and constantly learning things the hard way.\nI want to share this on LinkedIn, but every time it sounds awkward or forced.\nNot sure how to turn these thoughts into a personal post.";
