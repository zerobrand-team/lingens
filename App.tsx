            ...
            <div className="animate-in fade-in duration-300">
               {viewMode === 'templates' ? (
                 <div className="pb-10">
                    ...
                    <div className="grid grid-cols-2 gap-4 w-full">
                        {[
                          ...
                          <button key={t.id} onClick={() => handleTemplateSelect(t.id)} className="group text-left w-full flex flex-col gap-3">
                 ...
                 <div className="bg-white rounded-[32px] shadow-sm p-4 border border-gray-100">
                    ...
                    <button onClick={handleDownloadImage} className="w-full bg-black text-white font-bold mb-8 h-[42px] rounded-[14px] hover:bg-gray-800 transition-all flex items-center justify-between px-6 active:scale-[0.98] shadow-lg">
              ...
              <div className="h-full flex flex-col overflow-y-auto custom-scrollbar pt-2 pb-10">
                ...
                <div className="flex gap-5 flex-wrap">
                  {[
                    ...
                    <button key={t.id} onClick={() => handleTemplateSelect(t.id)} className="group text-center w-[160px] flex flex-col gap-3">
              ...
              <div className="w-full flex-1 bg-white rounded-[40px] shadow-sm flex flex-col p-6 border border-gray-100 h-full">
                ...
                <div className="flex-1 flex gap-6 overflow-hidden">
                  ...
                  <div className="w-[340px] flex flex-col h-full">
                    ...
                    <button onClick={handleDownloadImage} className="w-full bg-black text-white text-sm font-bold h-[42px] rounded-[14px] mt-6">{
