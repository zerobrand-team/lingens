      ...
      <div className="relative bg-white rounded-[32px] w-full max-w-md p-8 shadow-2xl animate-in fade-in zoom-in duration-300">
        ...
        <div className="text-center">
          ...
          <div className="space-y-3">
            {/* Кнопка LinkedIn */}
            <a 
              href="https://www.linkedin.com/in/voreio" // <--- Вставь свою ссылку
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 w-full h-[50px] bg-black text-white font-bold rounded-[16px] hover:bg-[#004182] transition-all active:scale-95"
            >
            ...
            {/* Кнопка Telegram */}
            <a 
              href="https://t.me/voreio" // <--- Вставь свой юзернейм
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 w-full h-[50px] bg-black text-white font-bold rounded-[16px] hover:bg-[#1A8LB0] transition-all active:scale-95"
            >
