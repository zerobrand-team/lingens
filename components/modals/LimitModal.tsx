        ...
        <div className="text-center">
          ...
          <div className="space-y-3">
            ...
            <a 
              ...
              className="flex items-center justify-center gap-2 w-full h-[50px] bg-[#111111] text-white font-bold rounded-[16px] hover:bg-[#004182] transition-all active:scale-95"
            >
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 w-full h-[50px] bg-[#111111] text-white font-bold rounded-[16px] hover:bg-[#1A8LB0] transition-all active:scale-95"
            >
